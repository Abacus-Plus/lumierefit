...
$cta_text = !empty($data['template']['cta_text']) ? $data['template']['cta_text'] : __('DODAJ U KORPU', 'checkout-upsell-woocommerce');
$has_variable = (bool)array_sum(array_column($filtered_products, 'is_variable'));
...
<section class="cuw-fbt-products cuw-products cuw-template cuw-mobile-responsive"
                            ...
                            <div class="cuw-product-actions" style="position: relative;">
                                ...
                                <div style="position: absolute; top: 0; right: 0;">
                                    ...
                                    if ($data['template']['checkbox'] == 'hidden') {
                                        ...
                                        $checkbox_style .= 'pointer-events: none; opacity: 0.5;';
                                    } ?>
                                ...
                                <div class="cuw-actions" style="display: none;">
                                    ...
                                    <div style="margin-top: 8px;">
                                        ...
                                        <button type="button"
                                            ...
                                            <?php esc_html_e("DODAJ U KORPU", 'checkout-upsell-woocommerce'); ?>
                                        </button>
                                    </div>
                                </div>
    ...
    <?php if ($has_variable) {
        echo apply_filters('cuw_fbt_template_choose_variants_modal', '', $filtered_products, $data); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    } ?>
</section>